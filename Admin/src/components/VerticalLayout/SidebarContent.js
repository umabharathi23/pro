          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/tasks-list">{props.t("List")}</Link>
                </li>

                <li>
                  <Link to="/add-task">{props.t("Add Task")}</Link>
                </li>
                ...
                {/* <li>
                  <Link to="/add-test">{props.t("Add test")}</Link>
                </li> */}
            ...
            <li>
              <Link to="/#" className="has-arrow waves-effect">
                <i className="mdi mdi-format-list-bulleted-type"></i>
                <span>{props.t("AddMarks")}</span>
              </Link>
              <ul className="sub-menu">
                
                <li>
                  <Link to="/marks-list">{props.t("List")}</Link>
                </li>

                <li>
                  <Link to="/add-marks">{props.t("Add Marks")}</Link>
                </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/tests-list">{props.t("List")}</Link>
                </li>

                <li>
                  <Link to="/add-test">{props.t("Add Tests")}</Link>
                </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to="/Students-List">{props.t("List")}</Link>
                </li>

                <li>
                  <Link to="/add-students">{props.t("Add Students")}</Link>
                </li>
