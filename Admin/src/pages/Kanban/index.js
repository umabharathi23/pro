          ...
          >
            <div className="form-group mb-3">
              <Label htmlFor="taskname" className="col-form-label">
                Enter Subject <span className="text-danger">*</span>
              </Label>
              <Col lg={12}>
                <Input
                  id="taskname"
            ...
            {/* <div className="form-group mb-3">
              <label className="col-form-label">Enter Topic</label>
              <Col lg={12}>
                <textarea
                  id="taskdesc"
            ...
            <div className="form-group mb-3">
              <label className="col-form-label">Enter Task</label>
              <Col lg={12}>
                <textarea
                  id="taskdesc"
                  className="form-control"
            ...
            {/* <div className="form-group mb-4">
              <label className="col-form-label">
                Enter Your Task Description<span className="text-danger">*</span>
              </label>
              <div className="col-lg-12">
                ...
                >
                  ...
                  <option defaultValue="secondary">FSD</option>
                  <option defaultValue="primary">AZURE DEVEOPS</option>
                  <option defaultValue="warning">AWS DEVEOPS</option>
                  <option defaultValue="success">GOOGLE DEVEOPS</option>
                  <option defaultValue="success">RPA</option>
                  <option defaultValue="success">DATA ANALYTICS</option>
                  <option defaultValue="success">PEGA</option>
                  <option defaultValue="success">GOOGLE FLUTTER</option>
                  <option defaultValue="success">BECOME CODER</option>
                  <option defaultValue="success">SKILLUP CODER</option>
                  <option defaultValue="success">BECOME CODER</option>
                  <option defaultValue="success">IGINITE CODER</option>
                </select>
